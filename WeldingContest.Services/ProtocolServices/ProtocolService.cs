...
{
    public class ProtocolService : IProtocolService<Contest>
    {
        private readonly WeldingContestContext weldingContestContext;

        public ProtocolService(WeldingContestContext weldingContestContext)
        {
        ...
        static List<int> CountMarks(List<ContestWork> contestWorks)
        {
