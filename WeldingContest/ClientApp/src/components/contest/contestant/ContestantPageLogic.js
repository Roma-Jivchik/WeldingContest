...
export class ContestantPageLogic extends Component {
    constructor(props) {
        super(props);
                        ...
                        <Form noValidate validated={this.state.validated}>
                            <fieldset hidden={!this.state.isActiveContestantForm}>
                                <Row>
                                    <Col>
                                        <fieldset disabled={this.state.isDisabled}>
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control size="sm" type="text" value={this.state.surname} placeholder={this.state.currentContestant.surname} onChange={this.handleChangeSurname} required />
                                            ...
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control size="sm" type="text" value={this.state.name} placeholder={this.state.currentContestant.name} onChange={this.handleChangeName} required />
                                                <Form.Control.Feedback type="invalid">
                                                    Пожалуйста, заполните поле
                                                </Form.Control.Feedback>
                                            </Form.Group>
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control size="sm" type="text" value={this.state.patronymic} placeholder={this.state.currentContestant.patronymic} onChange={this.handleChangePatronymic} />
                                            </Form.Group>
                                        </fieldset>
                                    </Col>
                                    <Col>
                                    ...
                                    <Col>
                                        <fieldset disabled={this.state.isUpdating}>
                                            <AddFileComponent handleFile={this.handleFile} file={this.state.file} imagePreviewUrl={this.state.imagePreviewUrl} isHidden={this.state.isUpdatingPhoto} />
                                        </fieldset>
                                    </Col>
                                </Row>
                            </fieldset>
                    ...
                    <Row>
                        <Col>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control size="sm" type="text" placeholder={this.state.currentContestSample.passportLink} />
                            </Form.Group>
                        </Col>
                        <Col>
                            <Form.Group className="mb-3">
        ...
        this.setState(
            {
                ...
                patronymic: contestant.patronymic,
